              ...
              <div class="card-body">
                <div class="dropdown float-end">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    ...
                    >
                    <a class="dropdown-item" href="#/home/patients/list"
                      ><i class="ri-list-check-2 me-1"></i>Liste des patients</a
                    >
                  </div>
                </div>
                <div class="mb-2 pb-2">
                  <img
                    src="assets/images/companies/patient_1.png"
                    alt=""
                    class="avatar-sm"
                  />
                </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="dropdown float-end">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="#/home/prescription/create"
                      ><i class="ri-list-check-2 me-1"></i>Voir toutes préscriptions</a
                    >
                  </div>
                </div>
                <div class="mb-2 pb-2">
                  <img
                    src="assets/images/companies/prescription.png"
                    alt=""
                    class="avatar-sm"
                  />
                </div>
        ...
        <div class="step-arrow-nav mt-n3 mb-2 bg-white shadow-sm">
          <ul class="nav nav-pills nav-justified bg-white custom-nav" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button
                class="nav-link p-3"
                id="patient-pending-tab"
                data-bs-toggle="pill"
                data-bs-target="#patient-pending"
                type="button"
                role="tab"
                aria-controls="patient-pending-tab"
                aria-selected="false"
              >
                Patients en attente
                <span class="badge bg-danger align-middle ms-1">{{
            ...
            <li class="nav-item" role="presentation">
              <button
                class="nav-link p-3"
                id="prescription_tab-btn"
                data-bs-toggle="pill"
                data-bs-target="#prescription-tab"
                type="button"
                role="tab"
