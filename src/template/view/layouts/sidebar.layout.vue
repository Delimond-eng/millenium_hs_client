    ...
    <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="#/home" class="logo logo-light" id="app-logo">
                ...
                <img src="assets/logo-2.png" class="card-logo card-logo-dark mt-2" alt="logo dark" height="60">
            </a>
                ...
                <ul class="navbar-nav" id="navbar-nav" v-if="$isAccessMenu('Tableau de bord')">
                    ...
                    <li class="nav-item" v-if="$isAccessMenu('Patients')">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarApps">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="#/home/patients/list" class="nav-link" data-key="t-chat"> Liste des patients
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item" v-if="$isAccessMenu('Suivis')">
                        ...
                        <div class="collapse menu-dropdown" id="suiviLanding">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="javascript:void(0)" class="nav-link" data-key="t-one-page"> Suivi patient </a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item" v-if="$isAccessMenu('Maternites')">
                        ...
                        <div class="collapse menu-dropdown" id="maternite">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="javascript:void(0)" class="nav-link" data-key="t-list"> Consultation
                                        postnatale </a>
                                </li>
                                <li class="nav-item">
                                    <a href="javascript:void(0)" class="nav-link" data-key="t-list"> Consultation prénatale
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="javascript:void(0)" class="nav-link" data-key="t-create"> Accouchement </a>
                                </li>

                                <li class="nav-item">
                                    <a href="javascript:void(0)" class="nav-link" data-key="t-create"> Création bébé </a>
                                </li>
                            </ul>
                        </div>
                    </li>
