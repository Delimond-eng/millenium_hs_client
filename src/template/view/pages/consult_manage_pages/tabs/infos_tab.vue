<template>
    <div class="tab-pane fade active show" id="custom-v-pills-home" role="tabpanel"
        ...
        <div>
            <div class="d-flex justify-content-between mt-3 align-items-center align-content-center" v-if="selectedPatient">
            ...
            <div class="border-1 border-bottom mb-2" v-if="selectedPatient">
            </div>
            ...
            selectedPatient.details[selectedPatient.details.length
                ...
                <div class="col-md-12">
                    <button type="button" class="btn btn-secondary btn-border btn-label mt-2 right nexttab nexttab"
                        @click.prevent="triggerNext"><i
                            class="ri-arrow-right-line label-icon align-middle fs-16 ms-2 "></i>Procèder à la
                        consultation
                    </button>
                </div>
            </div>
