          ...
          <div class="col-md-12">
            <div class="card ribbon-box right">
              <div class="card-header">
                <div
                  class="nav nav-pills nav-pills-tab custom-verti-nav-pills text-center"
                  role="tablist"
                  aria-orientation="vertical"
                >
                  <button
                    class="nav-link d-flex flex-fill me-2 flex-column justify-content-center align-items-center show"
                    :class="selectedPatient != null ? 'active' : ''"
                  ...
                  >
                    <img
                      src="assets/images/companies/patient_3.png"
                      class="d-block fs-20 mb-1 text-center"
                      style="height: 40px"
                    />
                    Patient infos
                  </button>
                  ...
                  >
                    <img
                      src="assets/images/companies/consult.png"
                      class="d-block fs-20 mb-1 text-center"
                      style="height: 40px"
                    />
                    Consultations
                    ...
                    <div class="tab-content text-muted mt-3 mt-lg-0">
                      ...
                      >
                        <form class="row" @submit.prevent="submitFormConsult">
                              ...
                              <div class="col-md-12">
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <option
                                      v-for="(item, index) in medSymptomes"
                                      :key="index"
                                      :value="item.value"
                                    >
                                      {{ item.value }}
                                ...
                                <div class="row mt-2">
                                  ...
                                  >
                                    ...
                                    <textarea
                                      ...
                                      :placeholder="
                                        detail.detail_libelle.toLowerCase() + '...'
                                      "
                                    ></textarea>
                                  </div>
                                </div>
                          ...
                          <div class="col-md-12 mt-2">
                            <label class="form-label text-dark"
                              >Diagnostic <sup class="text-danger">*</sup></label
                            >
                            <!-- wizard editor -->
                            <textarea
                              class="form-control"
                              placeholder="Saisir votre diagnostic..."
                              v-model="form_consult.diagnostic"
                              required
                            ></textarea>
                          </div>
                          <div class="col-md-12 mt-2">
                            ...
                            >
                              ...
                              >
                                <i
                                  class="ri-restart-line label-icon align-middle fs-16 ms-2"
                                ></i>
                                Annuler
                              </button>
                              <load-button
