<template>
    <div role="tabpanel">
        <div class="row">
            <div class="col-12 col-md-12 mb-3">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h5 class="mb-sm-0 text-uppercase fw-semibold">
                        Gestion des lits<sup class="text-danger text-lowercase fw-normal"></sup>
                    </h5>
                    <button @click="$showBsModal('bedCreateModal')" class="btn btn-soft-primary">
                        <i class="ri-add-line me-1"></i> Nouveau lit
                    </button>
                </div>
            </div>
            ...
            <div class="col-md-3" v-for="(data, index) in datas.lits" :key="index">
                <div class="card card-height-100 ribbon-box ribbon-fill right border shadow-none">
                    <div class="card-body">
                        <div class="ribbon fs-10 fw-bold" :class="data.lit_status.includes('dispo') ? 'ribbon-success' : 'ribbon-warning'
                            ">
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <span class="fs-12"><i class="ri-hospital-line me-1 align-bottom"></i>
                                        <span v-if="data.service">{{ data.service.service_libelle }}</span>
                                    </span>
                                </div>
        ...
        <state-empty v-if="datas.lits === undefined || datas.lits.length === 0" title="Aucune information répertoriée !"
                ...
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-body login-modal p-4">
                        ...
                        <p class="text-white-50">
                            Veuillez renseigner tous les champs pour créer un lit !
                        </p>
                    </div>
...
export default {
    ...
    methods: {
        submitForm(e) {
             ...
             */
            this.$store
                .dispatch("hospitalisation/addBed", this.form)
                .then((res) => {
                    console.log(res);
