<template>
                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Historique de facturations & paiements</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="me-2">
                                        <a href="javascript:void(0)" @click="$showBsModal('modalFacturePayment')"
    ...
    <payment-modal @on-refresh="$refs.dataTableFactures.reloadData()" />
</template>

<script>
import PaymentModal from "../../modals/modal_facture_payment.vue";
export default {
    name: "FacturesList",
    components: {
        PaymentModal,
        ...
        return {
            dataTableColumns: [
...

                {
                    ...
                    render: function (data, type, row) {
                        return (
                            row.facturation.facturation_config_montant +
                            " " +
                            row.facturation.facturation_config_montant_devise
                        );
                    },
                },
                {
                    ...
                    render: function (data, type, row) {
                        return (
                            parseFloat(`${row.facturation.facturation_config_montant}`) -
                            parseFloat(`${row.paiement_montant}`) +
                            " " +
                            row.facturation.facturation_config_montant_devise
                        );
                    },
