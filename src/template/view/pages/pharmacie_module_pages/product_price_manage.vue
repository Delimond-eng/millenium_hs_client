              ...
              <form @submit.prevent="submitForm" class="card-body">
                ...
                <div class="mb-2">
                  ...
                  <select class="form-control" ref="prodField" required>
                    <option value="" label="Sélectionnez une categorie" selected hidden></option>
                  </select>
                </div>
                <div class="mb-2">
                  <label for="basiInput" class="form-label">Pharmacie<sup class="text-danger">*</sup></label>
                  <select class="form-select" @change="loadStockInfo" v-model="form.pharmacie_id" required>
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="mb-2">
                      <label for="basiInput" class="form-label">Dernier stock prix achat unitaire
                      </label>
                      <div class="d-flex">
                        <input type="text" :value="stockInfos.stock_pa" class="form-control me-1"
                          placeholder="Entrer le prix unitaire..." required readonly />
                        <input type="text" :value="stockInfos.stock_pa_devise" class="form-control" style="width: 100px"
                          readonly />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="mb-2">
                      <label for="basiInput" class="form-label">Marge bénéf. en % <sup class="text-danger">*</sup>
                      </label>
                      <input type="text" @input="calculatePu" v-model="form.marge" class="form-control"
                        placeholder="marge...ex:10" required />
                    </div>
                  </div>
                </div>
                <div class="mb-2">
                  <label for="basiInput" class="form-label">P.U généré <sup class="text-danger">*</sup></label>
                  <div class="d-flex">
                    <input type="text" v-model="form.produit_prix" class="form-control me-2"
                      placeholder="Entrer le prix unitaire..." required readonly />
                    <input type="text" :value="stockInfos.stock_pa_devise" class="form-control" style="width: 100px"
                      readonly />
                  </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <table class="table table-striped table-nowrap">
                    ...
                    <tbody>
                      <tr v-for="(data, index) in config.productPrices" :key="index">
                        <th scope="row">
                          <span v-if="data.produit">#{{ data.produit.produit_code }}</span>
                        </th>
                        <td>
                ...
                data.produit.produit_libelle
                        ...
                        <td>
                          <span v-if="data.produit"><span v-if="data.produit.categorie">{{
                data.produit.categorie.categorie_libelle
              }}</span></span>
                        </td>
                        <td>
                          <span v-if="data.produit"><span v-if="data.produit.type">{{
