          ...
          <div class="col-md-5">
            <div class="card">
              <form @submit.prevent="submitForm" class="card-body">
                <!-- Basic Input -->
                <div>
                  <label for="basiInput" class="form-label">Catégorie Libellé <sup class="text-danger">*</sup></label>
                  <input type="text" class="form-control" id="basiInput" placeholder="Entrez le libellé de la categorie"
                    v-model="form.categorie_libelle" required />
                </div>
                ...
                <div class="mt-2">
                  ...
                  <textarea class="form-control" placeholder="Entrez une description..."
                    v-model="form.categorie_description"></textarea>
                </div>
