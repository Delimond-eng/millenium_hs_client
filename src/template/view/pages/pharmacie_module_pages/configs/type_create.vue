        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0">
                Configuration types des produits pharmaceutiques
                <small>(Ex: Injectable, comprimé...)</small>
              </h4>
          ...
          <div class="col-md-7">
            <div class="card">
              <div class="card-header align-items-center d-flex border-bottom-dashed">
                <h4 class="card-title mb-0 flex-grow-1">Liste des types</h4>
              </div>
                    ...
                    <table class="table align-middle" id="customerTable">
                      <thead class="table-light text-muted">
                        <tr>
                          ...
                          <th class="sort" data-sort="customer_name">Type Libellé</th>
                          <th class="sort" data-sort="action">Action</th>
                        </tr>
                      </thead>

                      <tbody class="list form-check-all">
                        <tr v-for="(data, index) in config.types" :key="index">
                          <th scope="row">
                            <div class="form-check">
                          ...
                          <td class="customer_name">{{ data.type_libelle }}</td>
                          <td>
          ...
          <div class="col-md-5">
            <div class="card">
              <form @submit.prevent="submitForm" class="card-body">
                <!-- Basic Input -->
                <div>
                  <label for="basiInput" class="form-label">Type Libellé <sup class="text-danger">*</sup></label>
                  <input type="text" class="form-control" id="basiInput"
                    placeholder="Entrez le libellé du type de produit..." v-model="form.type_libelle" />
                </div>
                ...
                <div class="mt-2">
                  ...
                  <textarea class="form-control" placeholder="Entrez une description..."
                    v-model="form.type_description"></textarea>
                </div>

                <bs-toast id="errorsToastType" :msg="errors_msg" />
                <div class="row">
                  <div class="col-md-12">
...
export default {
  ...
  methods: {
    submitForm(e) {
      ...
      this.$store
        .dispatch("pharmacie/createType", this.form)
        .then((res) => {
          ...
          if (res.errors !== undefined) {
            ...
            let toast = document.getElementById("errorsToastType");
          ...
          if (res !== null) {
            Swal({
              icon: "success",
              text: "Nouveau type ajouté avec succès !",
              toast: true,
