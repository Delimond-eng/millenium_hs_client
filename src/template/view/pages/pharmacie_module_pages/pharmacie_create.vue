          ...
          <div class="col-md-5">
            <div class="card">
              <form @submit.prevent="submitForm" class="card-body">
                <!-- Basic Input -->
                <div>
                  <label for="basiInput" class="form-label">Dénomination <sup class="text-danger">*</sup></label>
                  <input type="text" v-model="form.nom" class="form-control" id="basiInput"
                    placeholder="Entrez la dénomination de la pharmacie" />
                </div>
                <div class="mt-2">
                  <label for="basiInput" class="form-label">Téléphone <sup class="text-danger">(optionnel)</sup></label>
                  <input type="text" v-model="form.telephone" class="form-control" id="basiInput"
                    placeholder="Entrez le téléphone de contact" />
                </div>

                <!-- Input with Label -->
                <div class="mt-2">
                  <label for="labelInput" class="form-label">Adresse <sup class="text-danger">(optionnel)</sup></label>
                  <textarea v-model="form.adresse" class="form-control" placeholder="Entrez une adresse..."></textarea>
                </div>

                <bs-toast id="errorsToastPharma" :msg="errors_msg" />

                <div class="mt-2">
                  <label for="iconInputLocation" class="form-label">Emplacement <sup class="text-danger">*</sup></label>
                  <div class="form-icon">
                    <select class="form-select" id="iconInputLocation" v-model="form.emplacement_id" required>
                      <option selected label="Sélectionner un emplacement..." hidden></option>
                      <option v-for="(item, index) in appConfigs.emplacements" :key="index" :value="item.id">
                ...
                <div class="row">
                  <div class="col-xl-12">
                    <div class="search-box">
                      <input type="text" class="form-control search" placeholder="Recherche catégorie ..." />
