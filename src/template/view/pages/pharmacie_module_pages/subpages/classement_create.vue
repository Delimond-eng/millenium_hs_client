<template>
  <div class="card">
    ...
    <form @submit.prevent="submitForm" class="card-body">
      ...
      <div class="mt-2">
        <label for="basiInput" class="form-label"
          >Quantité<sup class="text-danger">*</sup></label
        >
        <input
          type="text"
          v-model="form.operation_qte"
          class="form-control"
          id="basiInput"
      ...
      <div class="mt-2">
        <label for="labelInput" class="form-label"
          >Observation <small>(optionnel)</small></label
        >
        <textarea
          v-model="form.operation_obs"
          class="form-control"
        ...
        <div class="col-md-12">
          <div class="d-flex justify-content-end align-items-end">
            <load-button
              btn-type="submit"
              :loading="formLoading"
              class-name="btn btn-secondary mt-2"
              >Classer & sauvegarder</load-button
            >
          </div>
        </div>
      </div>
