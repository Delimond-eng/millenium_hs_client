              ...
              <form @submit.prevent="submitForm" class="card-body">
                ...
                <div class="mb-2">
                  <label for="basiInput" class="form-label"
                    >Code produit <sup class="text-danger">*</sup></label
                  >
                  <input
                    type="text"
                    class="form-control"
                    ...
                    v-model="form.produit_code"
                    required
                  />
                </div>
                <div class="mb-2">
                  <label for="basiInput" class="form-label"
                    >Libellé <sup class="text-danger">*</sup></label
                  >
                  <input
                    type="text"
                    class="form-control"
                    ...
                    v-model="form.produit_libelle"
                    required
                  />
                </div>
                <div class="mb-2">
                  <label for="basiInput" class="form-label"
                    >Qté stock minimum pour alerter
                  ...
                  <input
                    ...
                    class="form-control"
                    id="basiInput"
                    placeholder="Entrez stock minimal pour alerter"
                    v-model="form.produit_stock_min"
                  />
                </div>

                <!-- Basic Input -->
                <div class="mb-2">
                  <label for="basiInput" class="form-label">Prix Unitaire</label>
                  <div class="d-flex">
                    <input
                      type="number"
                      ...
                      v-model="form.produit_prix_unitaire"
                      required
                    />
                    <select
                      class="form-control"
                      v-model="form.produit_prix_devise"
                      style="width: 100px"
                    >
                ...
                <div class="mb-2">
                  <label for="basiInput" class="form-label"
                    >Catégorie <sup class="text-danger">*</sup></label
                  >
                  <select class="form-control" v-model="form.categorie_id" required>
                    ...
                    <option
                      v-for="(data, index) in config.categories"
                      :key="index"
                      :value="data.id"
                    >
                ...
                <div class="mb-2">
                  ...
                  <select class="form-control" v-model="form.type_id" required>
                    ...
                    <option
                      v-for="(data, index) in config.types"
                      :key="index"
                      :value="data.id"
                    >
                      {{ data.type_libelle }}
                ...
                <div class="mb-2">
                  ...
                  <textarea
                    ...
                    v-model="form.produit_description"
                  ></textarea>
                </div>
                    ...
                    <table class="table align-middle" id="customerTable">
                      <thead class="table-light text-muted">
                        <tr>
                          ...
                          <th class="sort" data-sort="customer_name">Prix unitaire</th>
