                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="d-flex">
                                            <input type="date" v-model="form.date" class="form-control flex-fill me-2"
                                                required>
                                            <input type="time" v-model="form.heure" class="form-control" style="80px"
                                                required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-2" v-for="(item, index) in traitements" :key="index">
                                            <div class="col-md-6">
                                                <div class="d-flex">
                                                    <input type="text" class="form-control flex-fill me-2"
                                                        placeholder="Traitement..." v-model="item.ps_traitement_libelle">
                                            ...
                                            <div class="col-md-6">
                                                <div class="d-flex">
                                                    ...
                                                    <button @click="traitements.push({
                                                        ps_traitement_libelle: '',
                                                        ps_traitement_type: '',
                                                        ps_traitement_dosage: '',
                                                        ps_traitement_unite: ''
                                                    })" style="width: 50px;" class="btn btn-icon ms-1 btn-secondary"><i
                                                            class="ri-add-line"></i></button>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    methods: {
        ...
        submitForm(e) {
            ...
            this.formLoading = true;
            this.$store.dispatch('services/createPremiersoins', datas).then((res) => {
