<template>
    <teleport to="body">
        <div id="modalCreateVisite" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none">
                        ...
                        <form class="row" @submit.prevent="submitForm">
                                    ...
                                    <ul class="nav nav-pills nav-customs nav-danger mb-3" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#border-navs-home"
                                                role="tab" aria-selected="true">Informations personnelles</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" data-bs-toggle="tab" href="#border-navs-profile"
                                                role="tab" aria-selected="false" tabindex="-1">Signes vitaux</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" data-bs-toggle="tab" href="#border-navs-messages"
                                                role="tab" aria-selected="false" tabindex="-1">Paiement</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content text-muted">
                                        ...
                                        <div class="tab-pane" id="border-navs-profile" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div>
                                                        <label class="form-label">Poids<sup
                                                ...
                                                <div class="col-md-4">
                                                    <div>
                                                        ...
                                                        <div class="form-icon">
                                                            <input type="text" v-model="form.taille"
                                                                class="form-control form-control-icon"
                                                ...
                                                <div class="col-md-4 mt-3">
                                                    <div>
                                                        ...
                                                        <div class="form-icon">
                                                            <input type="text" v-model="form.tension_art"
                                                                class="form-control form-control-icon"
                                                ...
                                                <div class="col-md-4 mt-3">
                                                    <div>
                                                        <label class="form-label">Pulsation<sup
                                                                class="text-danger">(Optionnelle)</sup></label>
                                                        <div class="form-icon">
                                                            <input type="text" v-model="form.freq_cardio"
                                                                class="form-control form-control-icon"
                                                ...
                                                <div class="col-md-4 mt-3">
                                                    <div>
                                                        <label class="form-label">Saturation<sup
                                                                class="text-danger">(Optionnelle)</sup></label>
                                                        <div class="form-icon">
                                                            <input type="text" v-model="form.saturation"
                                                                class="form-control form-control-icon"
                                            ...
                                            <div class="mb-2 mt-2 col-md-6">
                                                ...
                                                <div class="d-flex">
                                                    <input type="number" v-model="paiement.montant"
                                                        class="form-control me-1 flex-fill" id="exampleInputEmail1"
                                                        placeholder="Entrer le montant du paiement..." required />
                                                    <select class="form-control flex-grow-0" style="width: 100px"
                                                        v-model="paiement.devise" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex justify-content-end align-items-end">
                                    <button type="button" @click.prevent="$closeBsModal('modalCreateVisite')"
                                        class="btn btn-light btn-border btn-lg mt-2 text-uppercase me-2">
                                        Fermer
                                    </button>
                                    <load-button btn-type="submit" :loading="formLoading"
                                        class-name="btn btn-success btn-border btn-lg mt-2 text-uppercase">Valider &
                                        soumettre</load-button>
                                </div>
                            </div>
                        </form>
                    </div>
