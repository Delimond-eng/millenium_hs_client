                    ...
                    function c(e) {
                        if (e.target && e.target.matches("a.nav-link span"))
                            if (0 == l(e.target.parentElement.nextElementSibling)) {
                                ...
                                Array.from(t.querySelectorAll(".menu-dropdown")).forEach(function(
                                    e
                                ) {
                            ...
                            for (
                                var a = document.getElementsByClassName("dropdown-custom-right"); 0 < a.length;
